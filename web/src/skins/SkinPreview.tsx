...
function Fixture({ mobile }: { mobile: boolean }) {
  ...
  return <div className="app-shell skin-preview-fixture">
    ...
    <main className={'page ' + (mobile ? 'page-mobile' : 'page-desktop')}>
      ...
      <div style={{ margin: '20px 0' }}><AmountSummary mobile={mobile} title="待还合计" amounts={[{ currency: 'CNY', amount: 1280 }, { currency: 'USD', amount: 12.6 }]} metrics={[{ count: 2, label: '笔账单' }]} /></div>
