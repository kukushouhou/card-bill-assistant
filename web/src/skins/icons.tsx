...
export const ExportOutlined = skinIcon('ExportOutlined', Original.ExportOutlined);
...
export const GithubOutlined = skinIcon('GithubOutlined', Original.GithubOutlined);
...
export const QuestionCircleOutlined = skinIcon('QuestionCircleOutlined', Original.QuestionCircleOutlined);
