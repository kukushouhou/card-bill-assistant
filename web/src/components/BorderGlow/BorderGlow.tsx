...
interface BorderGlowProps {
  ...
  colors?: string[];
  fillOpacity?: number;
  /** 由使用方统一驱动光源，保留原组件全部光效，仅关闭局部指针输入。 */
...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  return (
    <div
      ref={cardRef}
      onPointerMove={externalControl ? undefined : handlePointerMove}
      className={`border-glow-card${lightSurface ? ' border-glow-card--light' : ''}${externalControl ? ' border-glow-controlled' : ''} ${className}`}
      style={{
