...
- 当前稳定版本：`v0.2.3`（[查看本版本完整发布说明](./docs/releases/v0.2.3.md)）
- 官方容器镜像：`ghcr.io/kukushouhou/card-bill-assistant:0.2.3`
...
```bash
git clone --branch v0.2.3 --depth 1 https://github.com/kukushouhou/card-bill-assistant.git
...
| 变量 | 必填 | 默认值 | 用途 |
| --- | :---: | --- | --- |
| `APP_VERSION` | 否 | `0.2.3` | GHCR 镜像版本；生产环境建议固定版本 |
